...
const components: AppRouteModule = {
	...
	children: [
		...
		},
		{
			...
			component: () =>
				import("@viaz/components/button/demos/index.demo.md"),
			meta: {
		...
		},
		{
			...
			component: () =>
				import("@viaz/components/select/demos/index.demo.md"),
			meta: {
				title: "components.button",
				icon: "simple-icons:about-dot-me",
			},
		},
		{
			...
			component: () =>
				import("@viaz/components/table/demos/index.demo.md"),
			meta: {
				title: "components.button",
				icon: "simple-icons:about-dot-me",
			},
		},
		{
			...
			component: () =>
				import("@viaz/components/page/demos/index.demo.md"),
			meta: {
		...
		},
		{
			...
			component: () =>
				import(
					"@viaz/components/list-checkbox-group/demos/index.demo.md"
				),
			meta: {
				title: "components.button",
				icon: "simple-icons:about-dot-me",
...

		{
			...
			name: "components.configuration-object",
			component: () =>
				import(
					"@viaz/components/customization-object/demos/index.demo.md"
				),
			meta: {
				title: "components.configuration-object",
				icon: "simple-icons:about-dot-me",
			},
		},

		{
			...
			component: () =>
				import(
					"@viaz/components/configuration-value/demos/index.demo.md"
				),
			meta: {
		...
		},
		{
			...
			component: () =>
				import(
					"@viaz/components/checkbox-input-number/demos/index.demo.md"
				),
			meta: {
		...
		},
		{
			...
			component: () =>
				import(
					"@viaz/components/checkbox-group-input/demos/index.demo.md"
				),
			meta: {
...

		{
			...
			component: () =>
				import(
					"@viaz/components/checkbox-date-picker/demos/index.demo.md"
				),
			meta: {
...

		{
			...
			component: () =>
				import(
					"@viaz/components/checkbox-date-range-picker/demos/index.demo.md"
				),
			meta: {
