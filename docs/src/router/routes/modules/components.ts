...
const components: AppRouteModule = {
  ...
  children: [
...

    {
      ...
      component: () =>
        import("@viaz/components/customization-object/demos/index.demo.md"),
      meta: {
    ...
    },
    {
      ...
      component: () =>
        import("@viaz/components/overlay-scrollbar/demos/index.demo.md"),
      meta: {
    ...
    },
    {
      ...
      component: () => import("@viaz/components/tagify/demos/index.demo.md"),
      meta: {
    ...
    },
    {
      ...
      component: () => import("@viaz/components/explorer/demos/index.demo.md"),
      meta: {
