...
export interface PageCurdAction {
  position: "fl" | "fr" | "ro";
  component: string;
  props: object;
  emit: string;
...
export interface PageCurdProps {
  store: PageCurdStore;
  // store: any;
  tables: object;
  uri?: string | false;
  actions?: PageCurdAction[];
}

export type PageCurdGetters = PiniaGetterTree;

interface PageCurdApis {
  /**
   * 表格列数据 API
   */
...
export interface PageCurdState extends PiniaStateTree {
  apis: PageCurdApis;
...
export interface PageCurdActions extends PiniaActionTree {
...
export type PageCurdStore = Store<
  "page",
  PageCurdState,
  PageCurdGetters,
  PageCurdActions
...
export type PageCurdStoreDefinition = StoreDefinition<
  "page",
  PageCurdState,
  PageCurdGetters,
  PageCurdActions
