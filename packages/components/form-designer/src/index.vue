  ...
  <div :class="prefixCls">
    ...
    <div :class="`${prefixCls}-contents`">
      ...
      <div class="flex-1 flex w-full">
        ...
        <VzDynamicPanel width="400px" placement="right" ref="dpElRef">
          <div :class="`${prefixCls}-contents-right`">
            ...
            <div :class="`${prefixCls}-contents-right-props-wrapper`">
              <vz-overlay-scrollbar>
                <!-- 表单属性 -->
...
.@{prefix-cls} {
  ...
  &-contents {
    ...
    &-canvas {
      --at-apply: "bg-#eeeeee flex-1 px-4 flex flex-col  h-full box-border";
